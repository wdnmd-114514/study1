...
if("TRUE" STREQUAL "TRUE")
  set(package_SOURCE_PREFIX /media/xbot/8802F5C302F5B672/1/src/package)
  set(package_DEVEL_PREFIX /media/xbot/8802F5C302F5B672/1/devel)
  set(package_INSTALL_PREFIX "")
  set(package_PREFIX ${package_DEVEL_PREFIX})
else()
  set(package_SOURCE_PREFIX "")
  set(package_DEVEL_PREFIX "")
  set(package_INSTALL_PREFIX /media/xbot/8802F5C302F5B672/1/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'xbot <xbot@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/xbot/8802F5C302F5B672/1/src/package/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/xbot/8802F5C302F5B672/1/devel/lib;/home/xbot/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
